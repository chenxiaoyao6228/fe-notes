...
![](../../cloudimg/2023/html-2-canvas-simple-version.png)

完整的 demo 请看 👉 [在线效果预览](./_demo/frontend-screenshot/html2canvas.html), 查看示例代码请点击[此处](./_demo/frontend-screenshot/html2canvas.html)
...
完整的 demo 请看 👉 [在线效果预览](./_demo/frontend-screenshot/dom-to-image.html), 查看示例代码请点击[此处](./_demo/frontend-screenshot/dom-to-image.html)
